        ...
        >
          ...
          <div className="ml-auto flex items-center gap-3">
            <span
              ...
              title="Nothing here calls a network. Every figure is labelled with where it came from: a standard, an editable assumption, or a seeded run of this simulator."
            >
